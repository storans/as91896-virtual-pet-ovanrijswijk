...
def death_check(weight, name):
    if 1.5 <= weight <= 2.5:
        ...
        if 1.5 > weight:
             print("{} was underweight. Maybe next time feed your animal slightly more.".format(name))
             print("{}'s weight when they died was {}".format(name, weight))
        if 2.5 < weight:
             print("{} was overweight. Maybe next time exercise your animal slightly more.".format(name))
             print("{}'s weight when they died was {}".format(name, weight))
...
if __name__ == "__main__":
    ...
    while keep_going == "":
        ...
        # If the user chooses option 4
            ...
            keep_going = input("If you don't want to end the game press enter - If you are sure you want to end the game enter 'q': ")
            if keep_going != "":
